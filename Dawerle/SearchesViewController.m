        ...
        [_store loadObjectWithID:[[NSUserDefaults standardUserDefaults] objectForKey:localID] withCompletionBlock:^(NSArray *objectsOrNil, NSError *errorOrNil) {
            if (errorOrNil == nil) {
                ...
                dispatch_async( dispatch_get_main_queue(), ^{
                    ...
                    [tableView insertSections:indices withRowAnimation:UITableViewRowAnimationLeft];
                });
            } else {
...
- (UITableViewCell *)tableView:(UITableView *)tableVieww cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([dataID isEqualToString:@"villas"] || [dataID isEqualToString:@"flats"])
    {
        ...
        }else
        {
            ...
            ((FUIButton*)[cell viewWithTag:4]).buttonColor = [UIColor colorFromHexCode:@"ea4335"];
...
{
    return [NSString stringWithFormat:@"%@ : %li",@"بحث رقم",(long)section];
}
/*
